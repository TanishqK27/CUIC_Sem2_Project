...
| Guide | Description |
|-------|-------------|
| [Connecting to Database](guides/connecting-to-database.md) | Access the team's shared PostgreSQL database |
| [Environment Setup](guides/environment-setup.md) | Set up your development environment |
| [API Keys](guides/api-keys.md) | Configure API credentials |
| [Git Workflow](guides/git-workflow.md) | Branching, commits, and pull requests |
| [Using Claude Code](guides/using-claude-code.md) | Tips for working with Claude Code |
| [Skills Reference](guides/skills-reference.md) | Custom `/slash` commands |
...
| [Methodology](reference/methodology.md) | Research methodology |
