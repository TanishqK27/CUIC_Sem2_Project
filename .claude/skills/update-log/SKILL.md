...
- `name`: Team member's name (lowercase: tan, andrii, dietrich, ben, alfie, max, miran, mya, isameel, vansheeka)
...
1. **Validate the name** - Ensure it matches one of the 10 team members (lowercase):
   - tan, andrii, dietrich, ben, alfie, max, miran, mya, isameel, vansheeka
